...
write.csv(acc, "E:/Myotis_vivesi/DDMT/Mviv17_60_ACC_search_idx.csv", row.names = FALSE)
write.csv(search_acc, "E:/Myotis_vivesi/DDMT/Mviv17_60_search_acc.csv", row.names = FALSE)
