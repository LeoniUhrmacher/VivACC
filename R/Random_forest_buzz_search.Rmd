...
# 650 x 400
barplot(GINI$MeanDecreaseGini, names.arg = GINI$Variables, las = 2, bty = "L", ylab = "Mean Gini Decrease bs")
...
# 400 x 500
dotchart(GINI$MeanDecreaseGini, labels = GINI$Variables, main = "Mean Gini Decrease bs")
...
# 650 x 400
barplot(var.Accuracy$MeanDecreaseAccuracy, names.arg = var.Accuracy$Variables, las = 2, bty = "L", ylab = "Mean Accuracy Decrease bs")
...
# 400 x 500
dotchart(var.Accuracy$MeanDecreaseAccuracy, labels =  var.Accuracy$Variables, main = "Mean Accuracy Decrease bs")
