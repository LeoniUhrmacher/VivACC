...
# get buzz clip times
```{r}
buzz_clips <- list.files("E:/Myotis_vivesi/data/Audio/Mviv17/Mviv17_38/Buzz")
split_time <- strsplit(buzz_clips, split = "_")
buzz_times <- data.frame(file = buzz_clips,
  start_clip = ymd_hms("2000-01-01 12:00:00.001"), 
                                          segment = NA)

#Mviv17_34_U17_06_19_03_39_36.482_10U-U17_06_19_03_39_39.175_10U.wav_1
...
for(i in 1045:length(split_time)){
...
```{r}
#dir.create("E:/Myotis_vivesi/data/Audio/Mviv17/Mviv17_38/truebuzz")

write.csv(buzz_times, file = "E:/Myotis_vivesi/data/Audio/Mviv17/Mviv17_38/truebuzz/Mviv17_38_truebuzz.csv", row.names = FALSE)

buzz_times$offset <- 0
buzz_times$long_buzz_end <- 0

write.csv(buzz_times, file = "E:/Myotis_vivesi/data/Audio/Mviv17/Mviv17_38/truebuzz/Mviv17_38_truebuzz_offset.csv", row.names = FALSE)

offset <- read.csv("E:/Myotis_vivesi/data/Audio/Mviv17/Mviv17_38/truebuzz/Mviv17_38_truebuzz_offset.csv", sep = ";")
offset$start_clip <- ymd_hms(offset$start_clip)

write.csv(offset, file = "E:/Myotis_vivesi/data/Audio/Mviv17/Mviv17_38/truebuzz/Mviv17_38_truebuzz_offset1.csv", row.names = FALSE)
```

# manually add true buzz offset times and long_buzz_end
# reload buzz times with true buzzes added
```{r}
buzz_times <- read.csv("E:/Myotis_vivesi/data/Audio/Mviv17/Mviv17_38/truebuzz/Mviv17_38_truebuzz_offset.csv", sep = ";")
...
Metrics <- read.csv("E:/Myotis_vivesi/DDMT/Mviv17_38_metrics.csv")
str(Metrics)
...
```{r}
bin <- list.files("E:/Myotis_vivesi/data/Tagging_17_18/2017/Mviv17_38_ST")
