...
#load preDDMT
``` {r}
PreDDMT <- read.csv("E:/Myotis_vivesi/17_34/Mviv17_34_ACC_Call.csv")
...
#load postDDMT
``` {r}
PostDDMT <- read.csv("E:/Myotis_vivesi/DDMT/Mviv17_34_ACC_Call_split1.csv", sep = ";")
...
``` {r}
write.csv(ALL_DDMT_clean, file = "E:/Myotis_vivesi/17_34/Mviv17_34_metrics.csv", row.names = FALSE)

Metrics <- read.csv("E:/Myotis_vivesi/17_34/Mviv17_34_metrics.csv")
str(Metrics)
```