...
# 650 x 400
barplot(GINI$MeanDecreaseGini, names.arg = GINI$Variables, las = 2, bty = "L", ylab = "Mean Gini Decrease cf")
...
# 400 x 500
dotchart(GINI$MeanDecreaseGini, labels = GINI$Variables, main = "Mean Gini Decrease cf")
...
# 650 x 400
barplot(var.Accuracy$MeanDecreaseAccuracy, names.arg = var.Accuracy$Variables, las = 2, bty = "L", ylab = "Mean Accuracy Decrease cf")
...
# 400 x 500
dotchart(var.Accuracy$MeanDecreaseAccuracy, labels =  var.Accuracy$Variables, main = "Mean Accuracy Decrease cf")
...
save(dev, val, R.Forest, CM.dev, error.rate, min.OOB, var.Accuracy, GINI, CM.val, Precision, Recall, Accuracy, file = "E:/Myotis_vivesi/17_34_rm1/comm_forage/RF_cf.Rdata")
