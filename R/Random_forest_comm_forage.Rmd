...
plot(dev$behav, dev$range.stX, ylab = "range.stX", xlab = "", col = c(2:3))
...
par(mfrow = c(1,2))
hist(dev$range.stX[which(dev$behav == "comm")], xlim = c(0, 0.5), xlab = "range.stX", main = "comm")

hist(dev$range.stX[which(dev$behav == "forage")], xlim = c(0, 0.5), xlab = "range.stX", main = "forage")
