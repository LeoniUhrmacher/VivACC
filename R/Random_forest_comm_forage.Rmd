...
write.csv(data, file = "E:/Myotis_vivesi/17_34_rm1/Mviv17_34_comm_forage.csv", row.names = FALSE)
...
save(dev, val, R.Forest, CM.dev, error.rate, min.OOB, var.Accuracy, GINI, sum_imp, CM.val, AEA, Precision, Recall, Accuracy, file = "E:/Myotis_vivesi/17_34_rm1/548_8_RF.Rdata")
