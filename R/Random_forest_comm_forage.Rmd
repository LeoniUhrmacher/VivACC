...
par(mfrow = c(1,2))
hist(dev$mean.stZ[which(dev$behav == "comm")], xlim = c(0, 0.5), xlab = "mean.stZ", main = "comm")

hist(dev$mean.stZ[which(dev$behav == "forage")], xlim = c(0, 0.5), xlab = "mean.stZ", main = "forage")
