...
boxplot(dev$behav, dev$sd.Z, ylab = "sd.Z", names = levels(dev$behav), col = c(2:5))

plot(dev$behav, dev$sd.Z, ylab = "sd.Z", xlab = "", col = c(2:5))

hist(dev$sd.Z, xlim = c(0, 1.5), xlab = "sd.Z", main = "")



par(mfrow = c(1,2))
hist(dev$sd.Z[which(dev$behav == "comm")], xlim = c(0, 50), xlab = "sd.Z", main = "inactive")

hist(dev$sd.Z[which(dev$behav == "comm" | dev$behav == "search" | dev$behav == "buzz")], xlim = c(0, 50), xlab = "sd.Z", main = "active")

dev.off()


par(mfrow = c(1,2))
hist(dev$sd.Z[which(dev$behav == "comm")], xlim = c(0, 1.5), xlab = "sd.Z", main = "comm")

hist(dev$sd.Z[which(dev$behav == "search" | dev$behav == "buzz")], xlim = c(0, 1.5), xlab = "sd.Z", main = "forage")
