...
# get buzz clip times
```{r}
buzz_clips <- list.files("E:/Myotis_vivesi/data/Audio/Mviv17/Mviv17_33/Buzz")
...
```{r}
#dir.create("E:/Myotis_vivesi/data/Audio/Mviv17/Mviv17_33/truebuzz")

write.csv(buzz_times, file = "E:/Myotis_vivesi/data/Audio/Mviv17/Mviv17_33/truebuzz/Mviv17_33_truebuzz.csv", row.names = FALSE)

buzz_times$offset <- 0
buzz_times$long_buzz_end <- 0

write.csv(buzz_times, file = "E:/Myotis_vivesi/data/Audio/Mviv17/Mviv17_33/truebuzz/Mviv17_33_truebuzz_offset.csv", row.names = FALSE)

offset <- read.csv("E:/Myotis_vivesi/data/Audio/Mviv17/Mviv17_33/truebuzz/Mviv17_33_truebuzz_offset.csv", sep = ";")
offset$start_clip <- ymd_hms(offset$start_clip)

write.csv(offset, file = "E:/Myotis_vivesi/data/Audio/Mviv17/Mviv17_33/truebuzz/Mviv17_33_truebuzz_offset1.csv", row.names = FALSE)
```

# manually add true buzz offset times and long_buzz_end
# reload buzz times with true buzzes added
```{r}
buzz_times <- read.csv("E:/Myotis_vivesi/data/Audio/Mviv17/Mviv17_33/truebuzz/Mviv17_33_truebuzz_offset.csv", sep = ";")
...
```{r}
bin <- list.files("E:/Myotis_vivesi/data/Tagging_17_18/2017/Mviv17_33_ST")
