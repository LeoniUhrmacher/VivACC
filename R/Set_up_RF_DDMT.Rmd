...
acc <- fread("E:/Myotis_vivesi/DDMT/Mviv17_34_rm2_split1.txt")
...
write.csv(acc, "E:/Myotis_vivesi/17_34_rm2/Mviv17_34_acc_var.csv", row.names = FALSE)
...
```{r}
buzz_times <- read.csv("E:/Myotis_vivesi/data/Audio/Mviv17/Mviv17_34/truebuzz/Mviv17_34_truebuzz.csv")
offset <- fread("E:/Myotis_vivesi/17_34/Mviv17_34_truebuzz_offset.csv")
...
write.csv(offset, file = "E:/Myotis_vivesi/17_34/Mviv17_34_truebuzz_offset1.csv", row.names = FALSE)


# read in true_buzz_offset and calculate true_buzz_ends
true_buzz <- read.csv("E:/Myotis_vivesi/17_34/Mviv17_34_truebuzz_offset1.csv")
...
write.csv(true_buzz, "E:/Myotis_vivesi/17_34/Mviv17_34_true_buzz_end.csv", row.names = FALSE)
...
```{r}
# read in acc data
 acc <- read.csv("E:/Myotis_vivesi/17_34_rm2/Mviv17_34_acc_var.csv")

 acc$datetime <- ymd_hms(acc$datetime)

# read in true_buzz_end file
true_buzz_end <- read.csv("E:/Myotis_vivesi/17_34/Mviv17_34_true_buzz_end.csv")
...
comm_files <- list.files("E:/Myotis_vivesi/data/Audio/Mviv17/Mviv17_34/Commute", 
...
roost_files <- list.files("E:/Myotis_vivesi/data/Audio/Mviv17/Mviv17_34/Roost", 
                         include.dirs = FALSE, pattern = "Mviv*")
...
search_files <- list.files("E:/Myotis_vivesi/data/Audio/Mviv17/Mviv17_34/Search", 
                         include.dirs = FALSE, pattern = "Mviv*")
...
write.csv(acc, "E:/Myotis_vivesi/17_34_rm2/Mviv17_34_acc_var_idx.csv", row.names = FALSE)
...
```{r}
acc <- read.csv("E:/Myotis_vivesi/17_34_rm2/Mviv17_34_acc_var_idx.csv")
...
write.csv(acc, "E:/Myotis_vivesi/17_34_rm2/Mviv17_34_acc_var_idx_clean.csv", row.names = FALSE)
...
```{r}
acc <- read.csv("E:/Myotis_vivesi/17_34_rm2/Mviv17_34_acc_var_idx_clean.csv")
...
write.csv(buzz_acc, "E:/Myotis_vivesi/17_34_rm2/Mviv17_34_buzz_acc.csv", row.names = FALSE)
...
write.csv(comm_acc, "E:/Myotis_vivesi/17_34_rm2/Mviv17_34_comm_acc.csv", row.names = FALSE)
...
write.csv(roost_acc, "E:/Myotis_vivesi/17_34_rm2/Mviv17_34_roost_acc.csv", row.names = FALSE)
...
write.csv(search_acc, "E:/Myotis_vivesi/17_34_rm2/Mviv17_34_search_acc.csv", row.names = FALSE)
...
write.csv(acc_behav, "E:/Myotis_vivesi/17_34_rm2/Mviv17_34_acc_behav.csv", row.names = FALSE)
