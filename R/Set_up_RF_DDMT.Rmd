...
# corrected ACC values and calculated predictor variables are then saved as a text file


acc <- fread("E:/Myotis_vivesi/DDMT/Mviv17_38_split1.txt")


#### only for 17_49 with two splits from DDMT
acc1 <- fread("E:/Myotis_vivesi/DDMT/Mviv17_49_split1.txt")
acc2 <- fread("E:/Myotis_vivesi/DDMT/Mviv17_49_split2.txt")
...
write.csv(acc, "E:/Myotis_vivesi/17_38_rm1/Mviv17_38_acc_var.csv", row.names = FALSE)
...
```{r}
buzz_times <- read.csv("E:/Myotis_vivesi/data/Audio/Mviv17/Mviv17_38/truebuzz/Mviv17_38_truebuzz.csv")
offset <- fread("E:/Myotis_vivesi/17_38/Mviv17_38_truebuzz_offset.csv")
...
write.csv(offset, file = "E:/Myotis_vivesi/17_38/Mviv17_38_truebuzz_offset1.csv", row.names = FALSE)


# read in true_buzz_offset and calculate true_buzz_ends
true_buzz <- read.csv("E:/Myotis_vivesi/17_38/Mviv17_38_truebuzz_offset1.csv")
...
write.csv(true_buzz, "E:/Myotis_vivesi/17_38/Mviv17_38_true_buzz_end.csv", row.names = FALSE)
...
# read in acc data
 acc <- read.csv("E:/Myotis_vivesi/17_38_rm1/Mviv17_38_acc_var.csv")

 acc$datetime <- ymd_hms(acc$datetime)

# read in true_buzz_end file
true_buzz_end <- read.csv("E:/Myotis_vivesi/17_38/Mviv17_38_true_buzz_end.csv")
...
```{r}
# change 2017 to 2018 for 18_06; get_time1 for 17_49
...
# function for 17_49 and 17_38
# Mviv17_38_000001_U17_06_20_03_30_16.432_0U-U17_06_20_03_30_21.436_0U.wav_1.jpg
# Mviv17_49_021082_U17_06_23_08_43_48.346_363U-U17_06_22_08_43_45.498_363U.wav_23.jpg
...
comm_files <- list.files("E:/Myotis_vivesi/data/Audio/Mviv17/Mviv17_38/Commute", 
...
roost_files <- list.files("E:/Myotis_vivesi/data/Audio/Mviv17/Mviv17_38/Roost", 
                         include.dirs = FALSE, pattern = "Mviv*")
...
search_files <- list.files("E:/Myotis_vivesi/data/Audio/Mviv17/Mviv17_38/Search", 
                         include.dirs = FALSE, pattern = "Mviv*")
...
write.csv(acc, "E:/Myotis_vivesi/17_38_rm1/Mviv17_38_acc_var_idx.csv", row.names = FALSE)
...
acc <- read.csv("E:/Myotis_vivesi/17_38_rm1/Mviv17_38_acc_var_idx.csv")
...
write.csv(acc, "E:/Myotis_vivesi/17_38_rm1/Mviv17_38_acc_var_idx_clean.csv", row.names = FALSE)
...
```{r}
acc <- read.csv("E:/Myotis_vivesi/17_38_rm1/Mviv17_38_acc_var_idx_clean.csv")
...
buzz_acc <- acc %>% group_by(buzz_idx_clean) %>% 
  summarise(count = n(),
            ...
            sd.X = sd(ACCX), sd.Y = sd(ACCY), sd.Z = sd(ACCZ),
            ...
            sd.stX = sd(stX), sd.stY = sd(stY), sd.stZ = sd(stZ),
            ...
            sd.dX = sd(dX), sd.dY = sd(dY), sd.dZ = sd(dZ),
            ...
            sd.VeDBA = sd(VeDBA), sd.VeSBA = sd(VeSBA),
            mean.Pitch = mean(Pitch), max.Pitch = max(Pitch), min.Pitch = min(Pitch), 
            range.Pitch = diff(range(Pitch)), sd.Pitch = sd(Pitch),
            mean.Roll = mean(Roll), max.Roll = max(Roll), min.Roll = min(Roll), 
            range.Roll = diff(range(Roll)), sd.Roll = sd(Roll))
...
write.csv(buzz_acc, "E:/Myotis_vivesi/17_38_rm1/Mviv17_38_buzz_acc.csv", row.names = FALSE)
...
write.csv(comm_acc, "E:/Myotis_vivesi/17_38_rm1/Mviv17_38_comm_acc.csv", row.names = FALSE)
...
write.csv(roost_acc, "E:/Myotis_vivesi/17_38_rm1/Mviv17_38_roost_acc.csv", row.names = FALSE)
...
write.csv(search_acc, "E:/Myotis_vivesi/17_38_rm1/Mviv17_38_search_acc.csv", row.names = FALSE)
...
write.csv(acc_behav, "E:/Myotis_vivesi/17_38_rm1/Mviv17_38_acc_behav.csv", row.names = FALSE)
