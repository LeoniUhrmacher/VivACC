...
# get buzz clip times
```{r}
buzz_clips <- list.files("E:/Myotis_vivesi/data/Audio/Mviv17/Mviv17_34/Buzz")
...
```{r}
write.csv(buzz_times, file = "E:/Myotis_vivesi/data/Audio/Mviv17/Mviv17_34/truebuzz/Mviv17_34_truebuzz.csv", row.names = FALSE)
...
offset <- read.csv("E:/Myotis_vivesi/data/Audio/Mviv17/Mviv17_34/truebuzz/Mviv17_34_truebuzz_offset.csv", sep = ";")
offset$loud_buzz_end <- 0

write.csv(offset, file = "E:/Myotis_vivesi/data/Audio/Mviv17/Mviv17_34/truebuzz/Mviv17_34_truebuzz_offset.csv", row.names = FALSE)
```

# manually add true buzz offset times
# reload buzz times with true buzzes added
```{r}
buzz_times <- read.csv("E:/Myotis_vivesi/data/Audio/Mviv17/Mviv17_34/truebuzz/Mviv17_34_truebuzz_offset.csv", sep = ";")
buzz_times$start_clip <- ymd_hms(buzz_times$start_clip)
...
Metrics <- read.csv("E:/Myotis_vivesi/DDMT/Mviv17_34_metrics.csv")
str(Metrics)
...
```{r}
bin <- list.files("E:/Myotis_vivesi/data/Tagging_17_18/2017/Mviv17_34_ST")
