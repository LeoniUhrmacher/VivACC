...
#load preDDMT
``` {r}
PreDDMT <- read.csv("E:/Myotis_vivesi/17_60/Mviv17_60_ACC_Call.csv")
...
#load postDDMT
``` {r}
PostDDMT <- read.csv("E:/Myotis_vivesi/DDMT/Mviv17_60_ACC_Call_split1.csv", sep = ";")
...
``` {r}
write.csv(ALL_DDMT_clean, file = "E:/Myotis_vivesi/17_60/Mviv17_60_metrics.csv", row.names = FALSE)
