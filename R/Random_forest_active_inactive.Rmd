...
par(mfrow = c(1,2))
hist(dev$sd.dZ[which(dev$behav == "inactive")], xlim = c(0, 1.5), xlab = "sd.dZ", main = "inactive")

hist(dev$sd.dZ[which(dev$behav == "active")], xlim = c(0, 1.5), xlab = "sd.dZ", main = "active")
dev.off()
